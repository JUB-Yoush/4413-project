...
const AccountDetails: React.FC<AccountInfo> = (account: AccountInfo) => {
    ...
    return (
        <div className="px-8 pt-6 pb-8 mb-4 h-auto w-full grid items-center justify-center">
            {/*Account Section*/}
            <p className={"text-3xl mb-6"}>Account</p>
            <div className={"grid grid-cols-2 gap-4 place-items-start w-auto"}>
            ...
            <div className="px-8 pt-6 pb-8 mb-4 w-full h-auto grid items-center justify-center">
                <div className="mb-4">
